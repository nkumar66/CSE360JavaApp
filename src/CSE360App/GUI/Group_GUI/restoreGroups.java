...
public class restoreGroups {
     ...
     * @param role
     */
    public restoreGroups(Stage primaryStage, String role) {
        ...
        /***
         * This button just returns the user to the group page.
         */
        ...
        VBox layout = new VBox(10, fileSelection, returnButton);
